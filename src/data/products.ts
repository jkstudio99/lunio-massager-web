...
export const reviews: Review[] = [
  {
    ...
    productId: '1',
    author: '小美',
    avatar: 'https://api.dicebear.com/9.x/notionists/svg?seed=Xiaomei',
    role: 'Retail Planner',
    rating: 5,
    comment: {
      'zh-TW': '每天站櫃八小時，小腿都超緊。Calf 這款很適合工作日用，節奏不會太暴力，但放鬆感很乾淨。',
      en: 'After standing 8 hours in retail, my calves are always tight. The Calf model is perfect for workdays — gentle rhythm but deeply relaxing.',
    },
    product: { 'zh-TW': 'Lunio 智能小腿按摩器', en: 'Lunio Smart Calf Massager' },
  ...
  },
  {
    ...
    productId: '2',
    author: 'Sabrina',
    avatar: 'https://api.dicebear.com/9.x/notionists/svg?seed=Sabrina',
    role: 'Brand Manager',
    rating: 5,
    comment: {
      'zh-TW': 'Boot 款最喜歡的是包覆感，從腳到小腿整段都被照顧到，適合回家後完整收尾。',
      en: 'The Boot model wraps everything from foot to calf. Perfect for a full wind-down after getting home.',
    },
    product: { 'zh-TW': 'Lunio 智能靴型按摩器', en: 'Lunio Smart Boot Massager' },
    image: '/media/products/boot/20260304-lunio34100.jpg',
    date: '2026-03-08',
    verified: true,
  },
  {
    ...
    productId: '3',
    author: 'Wendy',
    avatar: 'https://api.dicebear.com/9.x/notionists/svg?seed=Wendy',
    role: 'Project Lead',
    rating: 4,
    comment: {
      'zh-TW': '頸肩這款外型很漂亮，不像一般按摩器那麼笨重。閱讀時拉帶一拉，肩頸很快就鬆下來。',
      en: 'The Neck & Shoulder model looks sleek — not bulky like typical massagers. Pull the strap while reading and tension melts away.',
    },
    product: { 'zh-TW': 'Lunio 頸肩舒壓按摩器', en: 'Lunio Neck & Shoulder Massager' },
  ...
  },
  {
    ...
    productId: '1',
    author: '志偉',
    avatar: 'https://api.dicebear.com/9.x/notionists/svg?seed=Zhiwei',
    role: 'Runner',
    rating: 5,
    comment: {
      'zh-TW': '跑步後用 Calf 做恢復很有感，尤其晚間用完之後，隔天腿會輕很多。',
      en: 'Using the Calf massager after a run makes a real difference. My legs feel noticeably lighter the next morning.',
    },
    product: { 'zh-TW': 'Lunio 智能小腿按摩器', en: 'Lunio Smart Calf Massager' },
  ...
  },
  {
    ...
    productId: '2',
    author: '淑芬',
    avatar: 'https://api.dicebear.com/9.x/notionists/svg?seed=Shufen',
    role: 'Studio Founder',
    rating: 5,
    comment: {
      'zh-TW': 'Boot 的存在感很強，但正因為包覆完整，放鬆感真的跟小腿款完全不一樣。送給媽媽她也超喜歡！',
      en: 'The Boot model is substantial, but that full wrap coverage delivers a completely different level of relaxation. My mom loves it too!',
    },
    product: { 'zh-TW': 'Lunio 智能靴型按摩器', en: 'Lunio Smart Boot Massager' },
  ...
  },
  {
    ...
    productId: '3',
    author: 'Mika',
    avatar: 'https://api.dicebear.com/9.x/notionists/svg?seed=Mika',
    role: 'Art Director',
    rating: 4,
    comment: {
      'zh-TW': '很喜歡 Neck & Shoulder 的 Titan White 配色，放在家裡不突兀，按鍵也很好上手。',
      en: 'Love the Titan White colorway — fits right into my living room. The controls are intuitive and easy to use.',
    },
    product: { 'zh-TW': 'Lunio 頸肩舒壓按摩器', en: 'Lunio Neck & Shoulder Massager' },
    image: '/media/products/neck/20260304-lunio33235.jpg',
    date: '2026-02-20',
    verified: true,
  },
];
